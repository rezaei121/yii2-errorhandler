...
use \developit\errorhandler\ErrorHandlerAsset;

ErrorHandlerAsset::register($this);
?>
...
<body>
    <div class="header">
        ...
        <div class="buttons" id="search-buttons">
            <button type="button" id="google" title="Google result">Google search</button>
            <button type="button" id="stackoverflow" title="Stack Overflow result">Stack Overflow search</button>
            <button type="button" id="yiiframework" title="Yii Framework result">Yii Framework search</button>
        </div>
    </div>
